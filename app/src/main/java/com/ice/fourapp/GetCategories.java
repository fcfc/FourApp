...
public class GetCategories extends Activity {
    String catID = null;
            ;
    ListView mListView;
    String cityName;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (buttonText.equals("Chinese")) { catID = chineseRestCatId; };
...
//        mListView.setAdapter(new CustomAdapter(this, venueList));
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View view, int position, long id) {
                ...
                Intent i = new Intent(GetCategories.this, PhotoScreen.class);
